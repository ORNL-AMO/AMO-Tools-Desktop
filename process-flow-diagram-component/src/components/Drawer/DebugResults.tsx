...
import { DiagramCalculatedData, DiagramSettings, getIsDiagramValid, getPlantSummaryResults, NodeErrors, NodeGraphIndex, PlantResults, ProcessFlowPart, TrueCostOfSystems } from 'process-flow-lib';
...
const DiagramResults = () => {
    ...
    if (isDiagramValid) {
        plantResults = getPlantSummaryResults(nodes, calculatedNodeData, graph, settings.electricityCost, waterTreatmentNodes, wasteTreatmentNodes, settings);
