...
## Pump Achievable Efficiency Calculator

Determine the achievable pump efficiency for various pump styles which are based on the Hydraulic Institute (HI) standard ANSI/HI 1.3-2000. The two values represent the average of the range presented in the HI standard (blue) and the maximum value (green).
...
The operating or nameplate speed at which the pump is running at. Used along with the measured/required flow rate, head, and number of stages, to calculate the pump specific speed. The specific speed is used to determine efficiency penalty associated with the particular pump application.
...
**Source: src/app/calculator/pumps/achievable-efficiency/achievable-efficiency-help/achievable-efficiency-help.component.html**