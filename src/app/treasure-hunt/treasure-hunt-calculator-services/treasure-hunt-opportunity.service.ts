...
export class TreasureHuntOpportunityService {
  ...
  updateTreasureHuntOpportunity(currentOpportunity: TreasureHuntOpportunity, selectedCalc: string, settings: Settings, customOpportunity: OpportunitySheet | AssessmentOpportunity) {
    ...
    if (selectedCalc === Treasure.airLeak) {
      ...
      updatedCard = this.opportunityCardsService.getCustomOpportunityCardData(opportunitySheet, settings, this.calculatorsService.itemIndex, treasureHunt.currentEnergyUsage);
      ...
      updatedCard = this.opportunityCardsService.getCustomOpportunityCardData(assessmentOpportunity, settings, this.calculatorsService.itemIndex, treasureHunt.currentEnergyUsage);
