...
export class ConvertInputDataService {
  ...
  convertTreasureHuntInputData(treasureHunt: TreasureHunt, oldSettings: Settings, newSettings: Settings): TreasureHunt {
    ...
    if (treasureHunt.fanAffinityLawOpportunities != undefined) {
      treasureHunt.fanAffinityLawOpportunities = this.fanAffinityLawTreasureHuntService.convertFanAffinityLawOpportunities(treasureHunt.fanAffinityLawOpportunities, oldSettings, newSettings);
    }
