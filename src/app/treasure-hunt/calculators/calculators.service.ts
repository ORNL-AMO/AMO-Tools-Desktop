...
export class CalculatorsService {
  ...
  copyOpportunity(opportunityCardData: OpportunityCardData, treasureHunt: TreasureHunt, settings: Settings): OpportunityCardData {
    if (opportunityCardData.opportunityType === Treasure.airLeak) {
      ...
      opportunityCardData = this.opportunityCardsService.getCustomOpportunityCardData(opportunityCardData.opportunitySheet, settings, opportunityCardData.opportunityIndex, treasureHunt.currentEnergyUsage);
      ...
      opportunityCardData = this.opportunityCardsService.getCustomOpportunityCardData(opportunityCardData.assessmentOpportunity, settings, opportunityCardData.opportunityIndex, treasureHunt.currentEnergyUsage);
      opportunityCardData.opportunityType = Treasure.assessmentOpportunity;
    } 
  ...
  saveOpportunityChanges(opportunityCardData: OpportunityCardData, treasureHunt: TreasureHunt, settings): TreasureHunt {
    ...
    if (opportunityCardData.opportunityType === Treasure.airLeak) {
      ...
      updatedCard = this.opportunityCardsService.getCustomOpportunityCardData(opportunityCardData.opportunitySheet, settings, opportunityCardData.opportunityIndex, treasureHunt.currentEnergyUsage);
      ...
      updatedCard = this.opportunityCardsService.getCustomOpportunityCardData(opportunityCardData.assessmentOpportunity, settings, opportunityCardData.opportunityIndex, treasureHunt.currentEnergyUsage);
