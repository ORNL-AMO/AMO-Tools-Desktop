...
import { IntegratedAssessment, ModificationEnergyOption } from '../../../shared/assessment-integration/assessment-integration.service';
...
export class AssessmentOpportunityComponent {
  ...
  constructor(private assessmentOpportunityService: AssessmentOpportunityService, private helperFunctions: HelperFunctionsService) { }
  ...
  save() {
    if (this.integratedAssessment && !this.assessmentOpportunity.existingIntegrationData) {
      ...
      if (this.integratedAssessment.hasModifications) {
        this.assessmentOpportunity.existingIntegrationData.energyOptions.modifications = this.integratedAssessment.energyOptions.modifications.filter(option => option.modificationId == this.integratedAssessment.selectedModificationId)
      }
    }
