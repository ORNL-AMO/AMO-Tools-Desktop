...
export class SuiteApiHelperService {
  ...
  getCompressorLubricantEnum(lubricant: number) {
    switch (lubricant) {
      case 0:
  ...
  getCompressorStageEnum(stage: number) {
    switch (stage) {
      case 0:
  ...
  getCompressorInputBasisEnum(compressorInputBasis: number) {
    switch (compressorInputBasis) {
      case 0:
