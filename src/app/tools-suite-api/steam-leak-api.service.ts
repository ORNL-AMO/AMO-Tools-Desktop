...
export class SteamLeakApiService {
    ...
    estimateMethodTurbineCalc(turbineEfficiency: number, leakRate: number, surveyInput?: Partial<SteamLeakSurveyInput>): SteamLeakSurveyResult {
        const instance = this.createSurveyInstance(surveyInput);
    ...
    orificeMethodCalc(turbineEfficiency: number, holeSize: number, dischargeCoef: number, atmPressure: number, surveyInput?: Partial<SteamLeakSurveyInput>): SteamLeakSurveyResult {
        const instance = this.createSurveyInstance(surveyInput);
