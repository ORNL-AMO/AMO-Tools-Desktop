...
export class FlueGasFormService {
  ...
  initEmptyVolumeForm(settings: Settings, loss?: number): UntypedFormGroup {
    ...
    let formGroup = this.formBuilder.group({
      ...
      'CH4': [undefined, Validators.required],
      'C2H6': [undefined, Validators.required],
      'N2': [undefined, Validators.required],
      'H2': [undefined, Validators.required],
      'C3H8': [undefined, Validators.required],
      'C4H10_CnH2n': [undefined, Validators.required],
      'H2O': [undefined, Validators.required],
      'CO': [undefined, Validators.required],
      'CO2': [undefined, Validators.required],
      'SO2': [undefined, Validators.required], 
      'O2': [undefined, Validators.required],
  ...
  initEmptyMassForm(settings: Settings, loss?: number): UntypedFormGroup {
    ...
    if (settings.unitsOfMeasure != 'Imperial') {
     ...
     let formGroup = this.formBuilder.group({
      ...
      'carbon': [undefined, Validators.required],
      'hydrogen': [undefined, Validators.required],
      'sulphur': [undefined, Validators.required],
      'inertAsh': [undefined, Validators.required],
      'o2': [undefined, Validators.required],
      'moisture': [undefined, Validators.required],
      'nitrogen': [undefined, Validators.required],
      'name': ['Loss #' + lossNumber, Validators.required]
    });
