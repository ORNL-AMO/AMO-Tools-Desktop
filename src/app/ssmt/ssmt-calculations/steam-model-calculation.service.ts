...
import { SSMTInputs, Header, PressureTurbine } from '../../shared/models/steam/ssmt';
...
export class SteamModelCalculationService {
  ...
  calculate(_inputData: SSMTInputs, _settings: Settings) {
    ...
    //4. Calculate energy use and costs
  }
  ...
  //   //1c. Model
  //   if (this.inputData.boilerInput.blowdownFlashed) {
  //     //use the ssmtOutputData.highPressureHeader here?
  //     //TODO: add lowPressureHeaderModel
  //     this.setBlowdownFlashTankModel(this.inputData.headerInput[2].pressure);
  ...
  //     {
  //       headerPressure: this.inputData.headerInput[0].pressure,
  //       inlets: [{
  ...
  //     this._settings
  //   ).header;
  //   this.ssmtOutputData.highPressureHeader = this.setHeatLoss(this.ssmtOutputData.highPressureHeader, this.inputData.headerInput[0].heatLoss);
  ...
  //   this.ssmtOutputData = this.balanceTurbinesService.balanceTurbines(this.inputData.turbineInput, this.ssmtOutputData, this.mediumPressureSteamNeed, this.lowPressureSteamNeed);
  ...
  //   this.initialHighPressureCondensate.massFlow = this.highPressureSteamUsage * (this.inputData.headerInput[0].condensationRecoveryRate / 100);
  //   this.finalHighPressureCondensate = this.initialHighPressureCondensate;

  //   if (this.inputData.headerInput[0].flashCondensateReturn) {
  ...
  //         tankPressure: this.inputData.headerInput[1].pressure
  //       },
  //       this._settings
  //     );
  ...
  //   if (this.inputData.headerInput[1].desuperheatSteamIntoNextHighest) {
  ...
  //         outletPressure: this.inputData.headerInput[1].pressure,
  ...
  //         desuperheatingTemp: this.inputData.headerInput[1].desuperheatSteamTemperature
  //       },
  //       this._settings
  //     );
  //   } else {
  ...
  //     {
  //       headerPressure: this.inputData.headerInput[1].pressure,
  //       inlets: [{
  ...
  //     this._settings
  //   ).header;
  //   this.ssmtOutputData.mediumPressureHeader = this.setHeatLoss(this.ssmtOutputData.mediumPressureHeader, this.inputData.headerInput[1].heatLoss);
  ...
  //   this.intitialMediumPressureCondensate.massFlow = this.mediumPressureSteamUsage * (this.inputData.headerInput[1].condensationRecoveryRate / 100);
  ...
  //   if (this.inputData.headerInput[1].flashCondensateIntoHeader) {
  ...
  //         tankPressure: this.inputData.headerInput[2].pressure
  //       },
  //       this._settings
  //     );
  ...
  //   if (this.inputData.headerInput[2].desuperheatSteamIntoNextHighest) {
  ...
  //         outletPressure: this.inputData.headerInput[2].pressure,
  //         feedwaterPressure: this.ssmtOutputData.feedwater.pressure,
  //         feedwaterThermodynamicQuantity: 1,//1 is enthalpy
  //         feedwaterQuantityValue: this.ssmtOutputData.feedwater.specificEnthalpy,
  //         desuperheatingTemp: this.inputData.headerInput[2].desuperheatSteamTemperature
  //       },
  //       this._settings
  //     );
  //   } else {
  ...
  //     {
  //       headerPressure: this.inputData.headerInput[2].pressure,
  //       inlets: [{
  ...
  //     this._settings
  //   ).header;
  //   this.ssmtOutputData.lowPressureHeader = this.setHeatLoss(this.ssmtOutputData.lowPressureHeader, this.inputData.headerInput[2].heatLoss);
  ...
  //   this.initialLowPressureCondensate.massFlow = this.lowPressureSteamUsage * (this.inputData.headerInput[2].condensationRecoveryRate / 100)
  ...
  //   //headers from UI
  //   let lowPressureHeaderInput: Header = this.inputData.headerInput[2];
  //   let mediumPressureHeaderInput: Header = this.inputData.headerInput[1];
  //   let highPressureHeaderInput: Header = this.inputData.headerInput[0];
  ...
  //   //1. Boiler
  //   this.initializeBoilerModel(this.inputData.boilerInput, highPressureHeaderInput);
  ...
  //     this.initializeReturnSteamFlashTank(this.inputData.boilerInput, lowPressureHeaderInput, mediumPressureHeaderInput, highPressureHeaderInput);
  //     //gas generated from flash tank (gas)
  //     this.condensateReturnVent = {
  //       pressure: this.ssmtOutputData.condensateFlashTank.outletGasPressure,
  //       temperature: this.ssmtOutputData.condensateFlashTank.outletGasTemperature,
  ...
  //   this.initializeCondensingTurbineModel(this.inputData.turbineInput.condensingTurbine, highPressureSteam);
  //   //8b. high pressure to low pressure turbine
  //   this.initializeHighPressureToLowPressureTurbine(this.inputData.turbineInput.highToLowTurbine, highPressureSteam, lowPressureHeaderInput);
  //   //8c. high pressure to medium pressure turbine
  //   this.initializeHighPressureToMediumPressureTurbine(this.inputData.turbineInput.highToMediumTurbine, highPressureSteam, mediumPressureHeaderInput);
  //   //8d. medium pressure to low pressure turbine
  //   this.initializeMediumPressureToLowPressureTurbine(this.inputData.turbineInput.mediumToLowTurbine, mediumPressureSteam, lowPressureHeaderInput);
  ...
  //   this.calculateTotalPowerCost(this.inputData.operationsInput);
  //   //10. calculate make up water
  //   this.initializeMakeupWater(this.inputData.operationsInput.makeUpWaterTemperature);
