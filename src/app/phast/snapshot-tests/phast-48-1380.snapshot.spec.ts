/**
 * Snapshot test: 48-1380
 *
 * Fuel-fired, Imperial, 1 charge material, 1 wall loss, 1 cooling loss, 1 modification.
 *
 * To regenerate snapshots:
 *   1. Set GENERATE = true
 *   2. Run: ng test --include="**\/phast-48-1380.snapshot.spec.ts" --watch=false --browsers=ChromeHeadless
 *   3. Pipe output through generate-snapshot.py into snapshots/48-1380.snap.json
...
const fixture = require('./fixtures/48-1380.json');
...
describe('Snapshot Test: 48-1380', () => {
  ...
  if (GENERATE) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const snapshots = require('./snapshots/48-1380.snap.json');
