/**
 * Snapshot test: 20-1367
 *
 * Fuel-fired, Imperial, 1 charge material, 1 wall loss, 1 modification.
 *
 * To regenerate snapshots:
 *   1. Set GENERATE = true
 *   2. Run: ng test --include="**\/phast-20-1367.snapshot.spec.ts" --watch=false --browsers=ChromeHeadless
 *   3. Pipe output through generate-snapshot.py into snapshots/20-1367.snap.json
...
const fixture = require('./fixtures/20-1367.json');
...
describe('Snapshot Test: 20-1367', () => {
  ...
  if (GENERATE) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const snapshots = require('./snapshots/20-1367.snap.json');
