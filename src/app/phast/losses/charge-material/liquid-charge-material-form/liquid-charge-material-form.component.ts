...
export class LiquidChargeMaterialFormComponent implements OnInit {
  ...
  async restoreMaterial() {
    ...
    let suiteDbResult = this.suiteDbService.insertLiquidLoadChargeMaterial(customMaterial);
