...
export class CoolingTabComponent implements OnInit {
  ...
  constructor(private lossesService: LossesService, private coolingLossesCompareService: CoolingLossesCompareService, private coolingLossesService: CoolingLossesService) { }
  ...
  ngOnInit() {
    ...
    this.coolingLossesCompareService.inputError.subscribe(val => {
      this.inputError = val;
      this.setBadgeClass();
    })
  }
