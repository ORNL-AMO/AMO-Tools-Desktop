...
@Component({
  selector: 'app-treasure-hunt-tutorial',
  templateUrl: './treasure-hunt-tutorial.component.html',
  styleUrls: ['./treasure-hunt-tutorial.component.css']
})
export class TreasureHuntTutorialComponent implements OnInit {
