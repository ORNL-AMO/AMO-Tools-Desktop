...
@Component({
  selector: 'app-ssmt-diagram-tutorial',
  templateUrl: './ssmt-diagram-tutorial.component.html',
  styleUrls: ['./ssmt-diagram-tutorial.component.css']
})
export class SsmtDiagramTutorialComponent implements OnInit {
