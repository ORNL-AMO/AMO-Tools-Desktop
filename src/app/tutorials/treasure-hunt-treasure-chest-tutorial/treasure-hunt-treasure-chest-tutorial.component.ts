...
@Component({
  selector: 'app-treasure-hunt-treasure-chest-tutorial',
  templateUrl: './treasure-hunt-treasure-chest-tutorial.component.html',
  styleUrls: ['./treasure-hunt-treasure-chest-tutorial.component.css']
})
export class TreasureHuntTreasureChestTutorialComponent implements OnInit {
  ...
  sendDontShow() {
    this.settingsDbService.globalSettings.disableTreasureHuntTreasureChestTutorial = this.dontShow;
