...
@Component({
  selector: 'app-phast-tutorial',
  templateUrl: './phast-tutorial.component.html',
  styleUrls: ['./phast-tutorial.component.css']
})
export class PhastTutorialComponent implements OnInit {
