...
const MEASURDefaultNotifications: Record<AppDefaultNotification, string> = {
  ...
  appDataStorageNotice: `<b class="bold title">You are running MEASUR in a web browser</b>. <br>Because MEASUR data is stored in this browser, 
  peforming operations that modify local storage, cookies, or cache for this website can result in data loss. DOE and MEASUR support staff do not have access to your data. 
  `
}
