...
import { AirLeakSurveyInput, AirSystemCapacityInput, CompressedAirPressureReductionData, FanAffinityLawsInput } from "./standalone";
...
export interface Calculator {
    ...
    affinityLawInputs?: FanAffinityLawsInput;
}
