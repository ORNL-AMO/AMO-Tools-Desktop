...
import { AssessmentIntegrationService, ExistingIntegrationData, IntegratedAssessment, IntegratedEnergyOptions } from './assessment-integration.service';
...
export class AssessmentIntegrationComponent implements OnInit {
  ...
  constructor(private assessmentIntegrationService: AssessmentIntegrationService) { }
  ...
  async setExistingIntegratedAssessment() {
    this.integratedAssessment = await this.assessmentIntegrationService.setIntegratedAssessment(this.existingIntegrationData.assessmentId, this.existingIntegrationData.assessmentType);
  ...
  async setNewIntegratedAssessment() {
    this.integratedAssessment = await this.assessmentIntegrationService.setIntegratedAssessment(this.assessmentIntegrationForm.controls.integratedAssessment.value, this.assessmentIntegrationForm.controls.assessmentType.value);
    if (this.integratedAssessment.hasModifications) {
