...
export class InventoryTableComponent {
  ...
  constructor(private inventoryService: ChillerInventoryService, private processCoolingService: ProcessCoolingService) { }

  ngOnInit(): void {
    this.settings = this.processCoolingService.settings.getValue();
