...
export class DayTypeUseFormService {
  ...
  getDayTypeUseForm(dayTypeEndUse: DayTypeEndUse, totalDayTypeAverageAirflow: number): UntypedFormGroup {
  ...
  getDayTypeUse(form: UntypedFormGroup): DayTypeEndUse {
    return {
  ...
  setAverageAirflowValidation(form: UntypedFormGroup, totalDayTypeAverageAirflow: number) {
