...
import { ExploreOpportunitiesBarChartComponent } from './explore-opportunities/explore-opportunities-bar-chart/explore-opportunities-bar-chart.component';
@NgModule({
  declarations: [
    ...
    ExploreOpportunitiesBarChartComponent
  ],
  imports: [
    CommonModule,
    RouterModule,
