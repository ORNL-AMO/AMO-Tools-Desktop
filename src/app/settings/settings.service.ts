...
export class SettingsService {
  ...
  getFormFromSettings(settings: Settings): FormGroup {
    ...
    return this.formBuilder.group({
      ...
      'eGridSubregion': settings.eGridSubregion || 'US Average',
      'totalEmissionOutput': settings.totalEmissionOutput || 0,
      'totalFuelEmissionOutput': settings.totalFuelEmissionOutput || 0,
  ...
  getSettingsFromForm(form: FormGroup) {
    let tmpSettings: Settings = {
      ...
      totalFuelEmissionOutput: form.controls.totalFuelEmissionOutput.value,
  ...
  getNewSettingFromSetting(settings: Settings): Settings {
    ...
    let newSettings: Settings = {
      ...
      totalFuelEmissionOutput: settings.totalFuelEmissionOutput,
