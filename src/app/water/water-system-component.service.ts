...
import { IntakeSource, WaterProcessComponent, DischargeOutlet, WasteWaterTreatment, WaterAssessment, KnownLoss, MonthlyIntakeData } from '../shared/models/water-assessment';
 ...
 */
  ...
  getAnnualUseFromMonthly(monthlyIntakeData: MonthlyIntakeData[]) {
    return monthlyIntakeData.reduce((annualUse, intakeData) => intakeData.flow + annualUse, 0)
  }
