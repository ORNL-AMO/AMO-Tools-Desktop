...
import { DiagramWaterSystemFlows, DischargeOutlet, EdgeFlowData, IntakeSource, KnownLoss, Modification, WasteWaterTreatment, WaterAssessment, WaterSystemFlows, WaterTreatment, WaterUsingSystem } from '../shared/models/water-assessment';
